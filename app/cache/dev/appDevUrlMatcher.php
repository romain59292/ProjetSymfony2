...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // rl_test_homepage
        if ($pathinfo === '/hello') {
            return array (  '_controller' => 'RL\\TestBundle\\Controller\\DefaultController::indexAction',  '_route' => 'rl_test_homepage',);
        }

        // fp_js_form_validator.check_unique_entity
        if ($pathinfo === '/fp_js_form_validator/check_unique_entity') {
